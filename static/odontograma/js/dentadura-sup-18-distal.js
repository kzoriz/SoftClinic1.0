function reset_check_distal(){
    ...
    if(chk_ausente.checked == true){
        ...
        console.log('distal_ausente: ' + chk_ausente.checked);
    ...
    if(chk_doenca_periodontal.checked == true){
        ...
        console.log('distal_doenca_periodontal: ' + chk_doenca_periodontal.checked);
    };
    ...
    if(chk_faceta_degaste.checked == true){
        ...
        console.log('distal_faceta_degaste: ' + chk_faceta_degaste.checked);
    };
    ...
    if(chk_fratura.checked == true){
        ...
        console.log('distal_fratura: ' + chk_fratura.checked);
    };
    ...
    if(chk_selante_fazer.checked == true){
        ...
        console.log('distal_selante_fazer: ' + chk_selante_fazer.checked);
    };
...
function distal(){
    ...
    const f = window.document.getElementById('display_distal');
    f.style.border = '2px solid black';
    f.style.marginBottom = '200px';
    f.style.marginTop = '200px';
    f.style.display = 'flex';
    const g = window.document.getElementById('display_oclusal');
    g.style.border = 'none';
    g.style.display = 'none';


    a.style.background = 'rgb(35,167,240)';
